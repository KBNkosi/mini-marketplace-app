...
const Hero = () => {
  return (
    <div 
      className="relative flex items-center justify-center h-[80vh] bg-cover bg-center bg-no-repeat text-white"
      style={{
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-20 max-w-4xl px-8 mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <button 
            className="px-8 py-3 bg-transparent text-white font-semibold rounded-md border-2 border-white 
                      hover:bg-white hover:bg-opacity-10 transition-all duration-200 transform hover:scale-105
