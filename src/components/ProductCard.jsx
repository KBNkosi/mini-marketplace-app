    ...
    <article className="h-full flex flex-col max-w-xs  rounded-lg shadow-md overflow-hidden bg-white hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-4 flex flex-col ">
        <header>
          ...
          <p className="text-lg font-medium text-blue-600">R {price} </p>
        </header>
      </div>
      <div className="p-4">
        ...
        <button className="border-2 my-1 w-[40%] bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 transition-colors duration-200  ">
          Add to cart
        </button>
      </div>
    </article>
